...
public class FileLoadService {
    public void analysisUrl(String url){
        ...
        try {
            ...
            if (judgeJsAndCss(html)){
               ...
               html= downLoadJs(html,hander);
               html= downLoadCSS(html,hander);
               html= downLoadImages(html,hander);
                downLoadHTML(html);
            }
    ...
    private String downLoadJs(String html,String hander) {
            ...
            while (matcher.find()) {
                ...
                if (script.contains("src=")) {
                    ...
                    FileOutputStream fileOutputStream = new FileOutputStream("D:/"+htmlName+"/" + name);
                    int len = 0;
    ...
    private String downLoadCSS(String html,String hander){
        try {
    ...
    private String downLoadImages(String html,String hander){
            ...
            while (matcher.find()) {
                ...
                InputStream inputStream = url.openStream();
                FileOutputStream fileOutputStream = new FileOutputStream("D:/"+htmlName+"/"+imageName);
                int len = 0;
                while ((len=inputStream.read())!=-1){
                    fileOutputStream.write(len);
                }
    ...
    private void downLoadHTML(String html){
        try {
            ...
            while (matcher.find()){
                ...
                if (htmlName!=null){
                    FileOutputStream fileOutputStream = new FileOutputStream("D:/"+htmlName+"/" + htmlName+".html");
